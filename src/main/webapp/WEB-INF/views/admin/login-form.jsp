	...
	<div class="row mt-5">
		<div class="col-6 offset-3">
			...
			<form id="form-register" class="border bg-light p-3" method="post" action="/login">
				...
				<h5>
					<div class="fw-bold mb-3">관리자 로그인</div>
				</h5>
				<hidden name="userType" value="employee" />
				...
				<div class="input-group mb-2">
				     ...
				     <input type="password" class="form-control" name="password" value="Zxcv1234!" placeholder="비밀번호">
			    </div>
			    <div>
			    ...
			    <div class="mt-2 text-end">
			     <span class="border-end border-secondary">
			     	<a href="/emp/find-password" class="me-1 text-decoration-none text-secondary">비밀번호 찾기</a>
			   	 	...
			   	 	<a href="/emp/login" class="ms-2 text-decoration-none text-secondary">직원 로그인</a>
			    </div>
			</form>	
		</div>
	</div>

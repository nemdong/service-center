...
<div class="container">
	...
	<div class="row mb-5">
		<div class="row mb-3" align="center">
			<div class="col">
				...
				<p><fmt:formatDate value="${reservationDto.reservationDate }" />&nbsp;${reservationDto.reservationHour }</p>	
				<p><strong>${reservationDto.locationName }</strong></p>
				<p>${reservationDto.locationBasicAddress }&nbsp;${reservationDto.locationDetailAddress }, ${reservationDto.zipcode }</p>
			</div>
		</div>
	</div>
	<hr	>
	<div class="row mb-3">
		...
		<div class="col-8">
			<p>기종 : ${reservationDto.deviceCategoryName }</p>
			<p>수리 내용 : ${reservationDto.serviceCatName }</p>
		</div>
	</div>
	<hr>
	<div class="row mb-3" align="center">
	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content">
			...
			<div class="modal-body" align="center">
				...
				<button type="submit" class="btn btn-primary btn-lg" id="btn-cancel-reserv">취소하기</button>
			</div>
			<div class="modal-footer">
			</div>
		</div>

						...
						<div class="me-4 ms-4"> 
							<div class="row mt-4 align-middle">
								...
								<div class="mb-4"> <!-- 아이디없으면 알림창 뜨게 구현 -->
									<input type="text" class="mb-1 form-control border-secondary" placeholder="사원번호 입력">
								...
								<div class="p-4 border mb-3">
									<div class="mb-3">
										...
										<span class="me-2">인사정보에 등록된 휴대전화로 인증
											<span name="mobileTel">(+** 1*-4***-2***)</span>
										</span>
									</div>
									<div class="d-none" id="detail-authemtication1">
										...
										<div>
											...
											<span><button type="button" class="ms-1 btn btn-sm btn btn-secondary">인증</button></span>

...
<div class="container">
   <div class="row mb-3">
   		<div class="col-2">
			...
			<c:set var="menu2" value="출장요청내역"/>
			<%@ include file="../common/leftbar.jsp" %>
   		</div>
   		<div class="col-10">
   			<div class="row mb-1">
				<div class="col-12"><h4 class="fw-bold fs-5">출장 요청 내역</h4></div>
			</div>
			<form mehtod="get" action="requestDetail">
				<div class="row mb-3">
					<div class="col-12">
						<div class="bg-light p-2">
							<div class="row">
								<div class="col-md-6">
									<input type="text" class="form-control" name="empNo" placeholder="사원번호 검색">
								</div>
								<div class="col-md-4">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-footer test-end">
								<button id="deny" type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">반려</button>
								<button id="okay" type="button" class="btn btn-primary btn-sm">승인</button>
...
$(function() {
	...
	$("#deny").click(function() {
		$("#modal-form").attr("action", "deny").trigger("submit");
		
	})
	
	$("#okay").click(function() {
		$("#modal-form").attr("action", "okay").trigger("submit");
